...
def cross_validation(K_fold, examples, dataset, neighbor_sample_size, D, E):
    ...
    for t in aggregator_types:
        ...
        for i in reversed(range(0, K_fold)):
            ...
            print("test_d")
            print(test_d)
            val_d, test_data = train_test_split(test_d, test_size=0.2)
            print("val_d")
            print(val_d)
            print("test_Data")
...
def representation(dataset,neighbor_size,depth,embedding_dim):
    ...
    process_data(dataset, neighbor_size, 5, depth, embedding_dim)
